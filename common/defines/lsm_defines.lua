...
NDefines.NAI.NAVAL_MISSION_PATROL_NEAR_OWNED = 140
NDefines.NAI.NAVAL_MISSION_DISTANCE_BASE = 1500
...
NDefines.NAI.FRONT_EVAL_UNIT_SUPPLY_AND_ORG_LACK_IMPACT = 1.5 --test
...
NDefines.NAI.MIN_INVASION_ORG_FACTOR_TO_EXECUTE = 0.7
